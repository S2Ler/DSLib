...
#define WEPopoverController_FADE_DURATION 0.3
...
- (void)presentPopoverFromRect:(CGRect)rect
  ...
  if ([self forwardAppearanceMethods]) {
    ...
    [UIView animateWithDuration:WEPopoverController_FADE_DURATION
                          delay:0.0
...
- (void)repositionPopoverFromRect:(CGRect)rect
  ...
  if (animated) {
    ...
    [UIView setAnimationDuration:WEPopoverController_FADE_DURATION];
